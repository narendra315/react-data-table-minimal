...
var ComponentName = (function (_super) {
    ...
    function ComponentName(props) {
        ...
        _this.processData = function () {
            var _a = _this.props, columns = _a.columns, noDataMessage = _a.noDataMessage, showLoader = _a.showLoader, renderLoader = _a.renderLoader;
            var _b = _this.state, data = _b.data, sortBy = _b.sortBy, sortOrder = _b.sortOrder;
            var processedData = data.sort(_this.compareValues(sortBy, sortOrder));
